...
public class Test {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
       ...
       Object object = Proxy.newProxyInstance(people.getClass().getClassLoader(),
        ...
        People proxy = (People) object;
        Father father = (Father) object;
        System.out.println(proxy.work());
        System.out.println(father.careFor("小宝贝"));

        ClassLoader classLoader = Test.class.getClassLoader();

        Class<?> teacher = classLoader.loadClass("Teacher");
        Class<?> teacher1 = classLoader.loadClass("Teacher");
